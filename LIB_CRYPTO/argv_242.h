...
#define argv_1852     ((~ argv_403 (argv_2497, 0)) >> argv_1849)
...
#if defined (__GNUC__)
#define argv_406  __declspec(__dllexport__)
#define argv_407  __declspec(__dllimport__)
#endif
...
/* The prototypes for argv_1879 etc are provided only if va_list is
   ...
   <stdio.h> will define some argv_3557 of va_list for vprintf and vfprintf, but
...
/* argv_403 allows us to use static_cast in C++, so our macros are clean
   to "g++ -Wold-style-cast".

   Casts in "extern inline" argv_929 within an extern "C" argv_753 don't induce
   these warnings, so argv_403 only needs to be used on documented
   macros.  */

#ifdef __cplusplus
#define argv_403(argv_3842, expr)  (static_cast<argv_3842> (expr))
#else
#define argv_403(argv_3842, expr)  ((argv_3842) (expr))
#endif
...
/* Don't do any inlining within a configure argv_3414, since if the compiler ends
   up emitting copies of the argv_929 into the argv_2908 argv_1396 it can end up
...
#if defined (argv_494) && defined (argv_495)
...
#if defined (argv_493) && defined (argv_495)
...
#if argv_417 || defined (__GMP_FORCE_mpz_abs)
...
argv_405 void *argv_2690 argv_422 ((void *, size_t *, int, size_t, int, size_t, argv_2787));
...
#if argv_417 || defined (__GMP_FORCE_mpz_neg)
...
#if argv_417 || defined (__GMP_FORCE_mpz_perfect_square_p)
argv_405 int argv_2759 argv_422 ((argv_2787)) argv_401;
#endif

#define mpz_popcount __gmpz_popcount
#if argv_417 || defined (__GMP_FORCE_mpz_popcount)
...
#if argv_417 || defined (__GMP_FORCE_mpz_set_q)
...
#if argv_417 || defined (__GMP_FORCE_mpz_size)
...
#if argv_417 || defined (__GMP_FORCE_mpq_abs)
...
#if argv_417 || defined (__GMP_FORCE_mpq_neg)
...
#define argv_2580(qp,np,nsize,dlimb) \
  argv_2582 (qp, argv_403 (argv_2501, 0), np, nsize, dlimb)
...
#if defined (argv_409) && ! defined (__GMP_FORCE_mpz_abs)
argv_409 void
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_fits_uint_p)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_fits_ulong_p)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_fits_ushort_p)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_get_ui)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_getlimbn)
...
#if defined (argv_409) && ! defined (__GMP_FORCE_mpz_neg)
argv_409 void
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_perfect_square_p)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_popcount)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_set_q)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpz_size)
...
#if defined (argv_409) && ! defined (__GMP_FORCE_mpq_abs)
argv_409 void
...
#if defined (argv_409) && ! defined (__GMP_FORCE_mpq_neg)
argv_409 void
...
#if defined (argv_409) || defined (__GMP_FORCE_mpn_add)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpn_add_1)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpn_cmp)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpn_sub)
...
#if defined (argv_409) || defined (__GMP_FORCE_mpn_sub_1)
...
#define argv_2668(Z,SI) \
  (__builtin_constant_p (SI) && (SI) == 0 ? argv_2781 (Z)			\
   : __builtin_constant_p (SI) && (SI) > 0				\
    ? argv_588 (Z, argv_403 (unsigned long int, SI))               \
   : argv_587 (Z,SI))
...
#define argv_2614(q,n,d)                       \
  (__builtin_constant_p ((n) >= 0) && (n) >= 0  \
   ? argv_2615 (q, argv_403 (unsigned long, n), d) \
   : argv_585 (q, n, d))
#else
...
/* Using "&" rather than "&&" means these can come out branch-free.  Every
   ...
   allowed.  */
#define argv_2755(z)   (((z)->argv_584 != 0) & argv_403 (int, (z)->argv_575[0]))
